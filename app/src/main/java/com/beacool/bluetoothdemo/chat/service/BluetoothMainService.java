...
import com.beacool.bluetoothdemo.chat.Constants;
...
public class BluetoothMainService extends Service {
    ...
    private IRecvBluetoothDataListener mRecvDataListener;

    public void setRecvDataListener(IRecvBluetoothDataListener dataListener) {
        this.mRecvDataListener = dataListener;
    }
...
//        }
    ...
    public void connected(BluetoothSocket socket, BluetoothDevice device,
        ...
        Log.e(TAG, Constants.DEVICE_NAME + " = " + device.getName());
...
//        }
    ...
    private void connectionFailed() {
        LogTool.LogE(TAG, "Unable to connect device");
        mState = STATE_NONE;
        // Update UI title
        updateUserInterfaceTitle();

        LogTool.LogE(TAG, "restart to connect device");
        start();
    }

    private void connectionLost() {
        // Send a failure message back to the Activity
        LogTool.LogE(TAG, "Device connection was lost");
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                ...
                LogTool.LogE(TAG, "Socket Type: " + mSocketType + "listen() failed", e);
            }
            mmServerSocket = tmp;
            mState = STATE_LISTEN;
        }
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                LogTool.LogE(TAG, "socket --->" + socket);
                // If a connection was accepted
                if (socket != null) {
                    LogTool.LogE(TAG, "mState = " + mState);
                    switch (mState) {
                        case STATE_LISTEN:
            ...
            LogTool.LogE(TAG, "END mAcceptThread, socket Type: " + mSocketType);
        }
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                try {
                    ...
                    String readContent = new String(buffer, 0, bytes);
                    LogTool.LogE(TAG, "read--->" + readContent);
                    if (mRecvDataListener != null) {
                        mRecvDataListener.onRecvBluetoothData(readContent);
                    }
                } catch (IOException e) {
